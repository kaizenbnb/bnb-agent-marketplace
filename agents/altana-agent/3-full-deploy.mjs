...
// --- Paso 4: grant_session (PRIMER toque de esta wallet en Altana) ---------
...
const session = await client.grantSession({
  ...
  permissions: {
    ...
    spend: [{ limit: parseUnits("0.05", 18), period: "day" }],
  },
...
// --- Paso 4.5: sembrar 100 USDT de test, vía sesion (no raw tx) ------------
console.log("\n=== Sembrando 100 USDT de test (allocateTo, via sesion Altana) ===");
const allocateCall = {
  to: USDT_ADDRESS,
  value: 0n,
...
// --- Paso 5: play 'supply' (approve + mint) --------------------------------
...
// --- Paso 6: position-check (solo lectura) ---------------------------------
...
const blocksPerYear = 10_512_000n; // ~10.5M bloques/año en BSC, per SKILL.md
